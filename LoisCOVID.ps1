...
$con=$true #是否在国内
$loc="北京市海淀区巨山路" #地理位置
if((Get-Date).DayOfWeek -gt 5) #周末
{
    $loc="北京市石景山区西井路" #地理位置
}

$temp=Get-Random -Minimum 1 -Maximum 3 #体温，0：35以下，1：35-36.4，2：36.5-36.9，3：37-37.3，4：37.4-38，5：38.1-38.5，6：38.6-39，7：39.1-40，8：40以上
...
$para= -Join('uid=',$uid, '&gid=', $gid, '&uni=', $uni, '&bj=', $bj, '&con=', $con, '&loc=', $loc, '&temp=', $temp, '&sit=', $sit, '&sym=', $sym, '&inf=', $inf, '&note=', $note, '&area=', $area, '&toge=', $toge, '&oth=', $oth, '&dat=', $dat)
